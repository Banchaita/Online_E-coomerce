      ...
      <Wrapper>
          ...
          <div className="flex-[1]">
            ...
            <div className="p-5 my-5 bg-black/[0.05] rounded-xl">
              ...
              <div className="text-sm md:text-md py-5 border-t mt-5">
                The subtotal reflects the totle price of your order, including duties and taxes, before
                any application discounts. It done not include delivery costs international transaction fees.
              </div>
            </div>
        ...
        {/* <div className="flex-[2] flex flex-col items-center pb-[50px] md:-mt-14">
          ...
          <span className="text-center mt-4">
            Looks like you have not added anything in your cart. <br /> Go ahead and explore top categories.
          </span>
